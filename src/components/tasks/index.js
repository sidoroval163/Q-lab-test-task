        ...
        <div className="tasks_wrapper">
            <div className="tasks_text">
                ...
                <p className="tasks_text_main">
                    Мы погружаемся в бизнес-процессы заказчика, понимаем его цели,<br />
                берем на себя целые направления. Поэтому с большинством клиентов<br />
                работаем годами. К нам обращаются, когда нуждаются в команде,<br />
                которая переосмыслит проект, ориентируясь на историю взаимодействия <br />
